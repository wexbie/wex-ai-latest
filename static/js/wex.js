...
const ayarButton = document.querySelector('.sidenav-butonu');
const modalOverlay = document.querySelector('.modal-wexai');
const kapatBtn = document.querySelector('.kapat-btn');
const wexbody = document.querySelector('.wexbody');
ayarButton.addEventListener('click', () => {
...
function yardimKapat() {
  document.getElementById('yardim-modal').style.display = 'none';
